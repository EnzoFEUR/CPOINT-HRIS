...
export default function StatutorySettings({ onBack }) {
    ...
    // Converts raw technical/database error messages into clean, HR-friendly alerts
    ...
    const handleChange = (e) => {
        ...
        // Block negative input directly at entry level
        if (numVal < 0) return;
    ...
    const handleSubmit = async (e) => {
        ...
        // 3. Logical Validation: PhilHealth Floor vs Ceiling
    ...
    if (fetching) {
        return (
            <div className="flex items-center justify-center py-20 text-slate-500 font-medium text-sm">
        ...
        <div className="space-y-6 max-w-7xl mx-auto pb-12">
            <div>
                <button
                    ...
                    className="inline-flex items-center space-x-2 text-slate-500 hover:text-slate-800 text-sm font-semibold transition-colors group cursor-pointer"
                >
                    <svg
            ...
            {successMessage && (
                <div className="bg-emerald-50 border border-emerald-200 text-emerald-800 px-4 py-3 rounded-xl flex items-center justify-between shadow-sm">
                    ...
                    <button
                        ...
                        className="text-emerald-600 hover:text-emerald-800 text-sm font-bold ml-4 cursor-pointer"
                    >
                        ✕
                    </button>
                </div>
            ...
            {errorMessage && (
                <div className="bg-amber-50 border border-amber-200 text-amber-900 px-4 py-3 rounded-xl flex items-center justify-between shadow-sm">
                    <div className="flex items-center space-x-2">
                    ...
                    <button
                        ...
                        className="text-amber-700 hover:text-amber-900 text-sm font-bold ml-4 cursor-pointer"
                    >
                        ✕
                    </button>
                </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100/80">
                    <div className="flex items-center space-x-3 mb-6">
                        ...
                        <h2 className="text-xl font-bold text-slate-800">SSS Contributions</h2>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            <label className="block text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-2">EMPLOYEE SHARE (%)</label>
                            <input
                                type="number"
                                min="0"
                                step="0.01"
                                ...
                                className="w-full bg-[#f8fafc] border border-slate-200/80 rounded-xl px-4 py-3 text-slate-800 font-semibold focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all"
                            />
                        </div>
                        <div>
                            <label className="block text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-2">EMPLOYER SHARE (%)</label>
                            <input
                                type="number"
                                min="0"
                                step="0.01"
                        ...
                        <div>
                            <label className="block text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-2">MAX SALARY CREDIT (₱)</label>
                            <input
                                type="number"
                                min="0"
                                name="sss_max_msc"
                ...
                <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100/80">
                    <div className="flex items-center space-x-3 mb-6">
                        ...
                        <h2 className="text-xl font-bold text-slate-800">PhilHealth Contributions</h2>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            <label className="block text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-2">TOTAL PREMIUM RATE (%)</label>
                            <input
                                type="number"
                                min="0"
                                step="0.01"
                                ...
                                onChange={handleChange}
                                className="w-full bg-[#f8fafc] border border-slate-200/80 rounded-xl px-4 py-3 text-slate-800 font-semibold focus:outline-none focus:ring-2 focus:ring-rose-500/20 focus:border-rose-500 transition-all"
                            />
                        </div>
                        <div>
                            <label className="block text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-2">MIN SALARY FLOOR (₱)</label>
                            <input
                                type="number"
                                min="0"
                        ...
                        <div>
                            <label className="block text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-2">MAX SALARY CEILING (₱)</label>
                            <input
                                type="number"
                                min="0"
                ...
                <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100/80">
                    <div className="flex items-center space-x-3 mb-6">
                        ...
                        <h2 className="text-xl font-bold text-slate-800">Pag-IBIG (HDMF) Contributions</h2>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            <label className="block text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-2">EMPLOYEE SHARE (%)</label>
                            <input
                                ...
                                onChange={handleChange}
                                className="w-full bg-[#f8fafc] border border-slate-200/80 rounded-xl px-4 py-3 text-slate-800 font-semibold focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all"
                            />
                        </div>
                        <div>
                            <label className="block text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-2">EMPLOYER SHARE (%)</label>
                        ...
                        <div>
                            <label className="block text-[11px] font-bold text-gray-400 uppercase tracking-wider mb-2">MAX MONTHLY CONTRIBUTION (₱)</label>
                            <input
                                type="number"
                                min="0"
                ...
                <div className="flex justify-end pt-2">
                    <button
                        type="submit"
                        disabled={loading}
                        className="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-8 py-3 rounded-xl shadow-sm transition duration-150 disabled:opacity-50 cursor-pointer flex items-center space-x-2"
                    >
                        {loading && (
